...
class OrderShipped extends Mailable
{
    ...
    private string $letter = 'order-shipped';
    ...
    public function __construct(Order $order, array $data)
    {
        ...
        $this->body = $this->replaceVariables($letter->getTranslation('body', $this->user->preferredLocale()) . $footer, $data);
//        dd($this->body);
    }
    ...
    {
        return [
            Attachment::fromPath($this->order->invoice->full_path),
        ];
    }

    private function replaceVariables($text, $data): string
    {
        $vars = [
