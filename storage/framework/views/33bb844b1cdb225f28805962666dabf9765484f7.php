...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('brand_create')): ?>
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="<?php echo e(route('admin.brands.create')); ?>">
                ...
                <tbody>
                    <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($brand->id); ?>">
                            ...
                            <td>
                                <span style="display:none"><?php echo e($brand->active ?? ''); ?></span>
                                <input type="checkbox" disabled="disabled" <?php echo e($brand->active ? 'checked' : ''); ?>>
                            </td>
                            <td>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('brand_show')): ?>
                                    <a class="btn btn-xs btn-primary" href="<?php echo e(route('admin.brands.show', $brand->id)); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('brand_edit')): ?>
                                    <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.brands.edit', $brand->id)); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('brand_delete')): ?>
                                    <form action="<?php echo e(route('admin.brands.destroy', $brand->id)); ?>" method="POST" onsubmit="return confirm('<?php echo e(trans('global.areYouSure')); ?>');" style="display: inline-block;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/italyskincare.com/resources/views/admin/brands/index.blade.php ENDPATH**/ ?>