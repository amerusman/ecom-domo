            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Product">
                <thead>
                    <tr>
                        ...
                        <th>
                            <?php echo e(trans('cruds.product.fields.showcase')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.product.fields.on_sale')); ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($product->id); ?>">
                            ...
                            <td>
                                <span style="display:none"><?php echo e($product->active ?? ''); ?></span>
                                <input type="checkbox" disabled="disabled" <?php echo e($product->active ? 'checked' : ''); ?>>
                            </td>
                            <td>
                                <span style="display:none"><?php echo e($product->in_stock ?? ''); ?></span>
                                <input type="checkbox" disabled="disabled" <?php echo e($product->in_stock ? 'checked' : ''); ?>>
                            </td>
                            <td>
                                <?php echo e(($product->prices && is_array($product->prices)) ? implode(', ', $product->prices) : ''); ?>
                            ...
                            <td>
                                <span style="display:none"><?php echo e($product->showcase ?? ''); ?></span>
                                <input type="checkbox" disabled="disabled" <?php echo e($product->showcase ? 'checked' : ''); ?>>
                            </td>
                            <td>
                                <span style="display:none"><?php echo e($product->on_sale ?? ''); ?></span>
                                <input type="checkbox" disabled="disabled" <?php echo e($product->on_sale ? 'checked' : ''); ?>>
                            </td>
                            <td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/italyskincare.com/resources/views/admin/products/index.blade.php ENDPATH**/ ?>