    ...
    <div class="page-wrapper r1-container">
        ...
        <main class="r1-main">
            <section class="section-address divider">
                ...
                <form method="POST" action="<?php echo e(route('profile.addresses.update', $address)); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/italyskincare.com/resources/views/profile/addresses/edit.blade.php ENDPATH**/ ?>