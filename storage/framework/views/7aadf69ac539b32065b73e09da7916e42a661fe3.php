    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="<?php echo e(route('admin.pages.create')); ?>">
                <?php echo e(trans('global.add')); ?> <?php echo e(trans('cruds.page.title_singular')); ?>
...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('cruds.page.title_singular')); ?> <?php echo e(trans('global.list')); ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($page->id); ?>">
                            ...
                            <td>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('page_show')): ?>
                                    <a class="btn btn-xs btn-primary" href="<?php echo e(route('admin.pages.show', $page)); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('page_edit')): ?>
                                    <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.pages.edit', $page)); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('page_delete')): ?>
                                    <form action="<?php echo e(route('admin.pages.destroy', $page)); ?>" method="POST" onsubmit="return confirm('<?php echo e(trans('global.areYouSure')); ?>');" style="display: inline-block;">
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('page_delete')): ?>
  ...
  let deleteButton = {
    ...
    url: "<?php echo e(route('admin.pages.massDestroy')); ?>",
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/italyskincare.com/resources/views/admin/pages/index.blade.php ENDPATH**/ ?>