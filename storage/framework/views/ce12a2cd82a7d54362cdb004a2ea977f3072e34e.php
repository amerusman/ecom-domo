        ...
        <main class="r1-main">
            <section class="r1-section-products divider">
                <div class="r1-title-wrapper">
                    ...
                    <h4 class="r1-subtitle"><span><?php echo e(__('web.trending')); ?></span></h4>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/italyskincare.com/resources/views/trending.blade.php ENDPATH**/ ?>