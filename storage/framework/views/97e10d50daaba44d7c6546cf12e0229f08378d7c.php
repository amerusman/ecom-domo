...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('currency_create')): ?>
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="<?php echo e(route('admin.currencies.create')); ?>">
                <?php echo e(trans('global.add')); ?> <?php echo e(trans('cruds.currency.title_singular')); ?>
...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('cruds.currency.title_singular')); ?> <?php echo e(trans('global.list')); ?>
            ...
            <table class=" table table-bordered table-striped table-hover datatable">
                <thead>
                    <tr>
                        ...
                        <th>
                            <?php echo e(trans('cruds.currency.fields.sign')); ?>
                        ...
                        <tr data-entry-id="<?php echo e($currency->id); ?>">
                            ...
                            <td>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('currency_show')): ?>
                                    <a class="btn btn-xs btn-primary" href="<?php echo e(route('admin.currencies.show', $currency->id)); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('currency_edit')): ?>
                                    <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.currencies.edit', $currency->id)); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('currency_delete')): ?>
                                    <form action="<?php echo e(route('admin.currencies.destroy', $currency->id)); ?>" method="POST" onsubmit="return confirm('<?php echo e(trans('global.areYouSure')); ?>');" style="display: inline-block;">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/italyskincare.com/resources/views/admin/currencies/index.blade.php ENDPATH**/ ?>