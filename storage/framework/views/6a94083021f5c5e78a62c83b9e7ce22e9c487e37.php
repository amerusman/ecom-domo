            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Coupon">
                <thead>
                    <tr>
                        ...
                        <th>
                            <?php echo e(trans('cruds.coupon.fields.name')); ?>
                        ...
                        <th>
                            <?php echo e(trans('cruds.coupon.fields.active')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.coupon.fields.discount')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.coupon.fields.limit')); ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($coupon->id); ?>">
                            <td>
                            ...
                            <td>
                                <span style="display:none"><?php echo e($coupon->active ?? ''); ?></span>
                                <input type="checkbox" disabled="disabled" <?php echo e($coupon->active ? 'checked' : ''); ?>>
                            </td>
                            <td>
                            ...
                            <td>
                                <?php echo e($coupon->limit ?? ''); ?>

                            </td>
                            <td>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('coupon_show')): ?>
                                    <a class="btn btn-xs btn-primary" href="<?php echo e(route('admin.coupons.show', $coupon->id)); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('coupon_edit')): ?>
                                    <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.coupons.edit', $coupon->id)); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('coupon_delete')): ?>
                                    <form action="<?php echo e(route('admin.coupons.destroy', $coupon->id)); ?>" method="POST" onsubmit="return confirm('<?php echo e(trans('global.areYouSure')); ?>');" style="display: inline-block;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/italyskincare.com/resources/views/admin/coupons/index.blade.php ENDPATH**/ ?>