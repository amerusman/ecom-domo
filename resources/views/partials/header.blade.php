...
<header class="r1-header">
    ...
    <nav class="r1-header__menu">
        ...
        {{--    <li class="menu-item has-sub-menu">
                <a href="{{ route('brands.index') }}">{{ Trans::__('brands') }}
                ...
                <ul class="sub-menu">
                    @foreach($brands as $brand)
                        <li class="menu-item">
                            <a href="{{ route('brands.show', $brand) }}">{{ $brand->name }}
                            </a>
                        </li>
                    @endforeach
                </ul>
            ...
            <li class="menu-item has-sub-menu">
                <a href="{{ route('categories.index') }}">{{ Trans::__('categories') }}
                    <svg width="13" height="8" viewBox="0 0 13 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12.2071 1.03247L6.75209 6.89026L1.29706 1.03247" stroke="#000000"/>
                    </svg>
                </a>
            ...
            <li class="menu-item hidden">
                <a href="{{ route('get-in-touch') }}">{{ __('web.get_in_touch') }}</a>
            </li>
        </ul>
    ...
    <a href="/{{ app()->getLocale() }}" class="r1-header__logotype">
    ...
    <ul class="r1-header__links">
        ...
        <li class="link-item">
            <a href="@guest(){{ route('register') }}@else{{ route('profile.home') }}@endguest">
        ...
        <li class="link-item mini-cart">
            <a href="javascript:;" class="r1-cart-popup-trigger" data-popup="shopping-cart">
                ...
                <span class="counter" id="cart-count">{{ Cart::quantity() }}</span>
            </a>
            <!-- .r1-popup-wrapper -->
        ...
        <li class="link-item languages">
            <span class="languages__curent">{{ Str::upper(app()->getLocale()) }}</span>
            <ul>
                @foreach($languages as $lang)
                    @if($lang->locale != app()->getLocale())
                        <li>
                            <a href="{{ \App\Helpers\Utils::changeLocale($lang->locale) }}">{{ Str::upper($lang->code) }}</a>
                        </li>
                    @endif
                @endforeach
            </ul>
