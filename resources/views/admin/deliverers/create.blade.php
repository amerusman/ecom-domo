...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.deliverer.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.deliverers.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('site') ? 'is-invalid' : '' }}" type="text" name="site" id="site" value="{{ old('site', '') }}" required>
                @if($errors->has('site'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tracking_url') ? 'is-invalid' : '' }}" type="text" name="tracking_url" id="tracking_url" value="{{ old('tracking_url', '') }}">
