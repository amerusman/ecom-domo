        ...
        <form method="POST" action="{{ route("admin.coupons.update", [$coupon->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="active" id="active" value="1" {{ $coupon->active || old('active', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('start_at') ? 'is-invalid' : '' }}" type="text" name="start_at" id="start_at" value="{{ old('start_at', $coupon->start_at) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('expiry_at') ? 'is-invalid' : '' }}" type="text" name="expiry_at" id="expiry_at" value="{{ old('expiry_at', $coupon->expiry_at) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discount') ? 'is-invalid' : '' }}" type="number" name="discount" id="discount" value="{{ old('discount', $coupon->discount) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('limit') ? 'is-invalid' : '' }}" type="number" name="limit" id="limit" value="{{ old('limit', $coupon->limit) }}" step="1">
                @if($errors->has('limit'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('limit_user') ? 'is-invalid' : '' }}" type="number" name="limit_user" id="limit_user" value="{{ old('limit_user', $coupon->limit_user) }}" step="1">
