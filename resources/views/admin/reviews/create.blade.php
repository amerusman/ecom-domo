...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.reviews.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="advantages">{{ trans('cruds.review.fields.advantages') }}</label>
                <input class="form-control {{ $errors->has('advantages') ? 'is-invalid' : '' }}" type="text" name="advantages" id="advantages" value="{{ old('advantages', '') }}">
                @if($errors->has('advantages'))
                    <span class="text-danger">{{ $errors->first('advantages') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.review.fields.advantages_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="disadvantages">{{ trans('cruds.review.fields.disadvantages') }}</label>
                <input class="form-control {{ $errors->has('disadvantages') ? 'is-invalid' : '' }}" type="text" name="disadvantages" id="disadvantages" value="{{ old('disadvantages', '') }}">
                @if($errors->has('disadvantages'))
                    <span class="text-danger">{{ $errors->first('disadvantages') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.review.fields.disadvantages_helper') }}</span>
            </div>
            <div class="form-group">
