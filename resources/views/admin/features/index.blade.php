            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Feature">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.feature.fields.key') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($features as $key => $feature)
                        <tr data-entry-id="{{ $feature->id }}">
                            ...
                            <td>
                                @can('feature_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.features.show', $feature->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('feature_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.features.edit', $feature->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
