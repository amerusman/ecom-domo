    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-currencyCountries">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($countries as $key => $country)
                            <tr data-entry-id="{{ $country->id }}">
                                ...
                                <td>
                                    <span style="display:none">{{ $country->active ?? '' }}</span>
                                ...
                                <td>
                                    @foreach($country->languages as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-currencyCountries:not(.ajaxTable)').DataTable({ buttons: dtButtons })
